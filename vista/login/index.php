...
<body class="text-center">
  ...
  <div style="background: white; width: 400px; position: fixed; border-top: 5px solid #dd4b39;" class="login-box-body">
	...
	<p class="login-box-msg"><h5>PORTAL DE CITAS</h5></p>
    ...
    <img src="<?php echo constant('URL')?>public/img/agro.png" class="rounded">
      ...
      <form class="form-signin">
        ...
        <button onclick="verificarDatos(event)" type="submit" class="btn btn-danger btn-block btn-flat" id="ingresar">Iniciar Sesión</button>
    ...
    <div class="row login-link" style="border-top: 3px solid #dd4b39;">
      <div class="col-md-4 col-sm-4 col-xs-4" style="margin-top: 10px;">
        <a onclick="" href=""><img src="<?php echo constant('URL')?>public/img/student.png" /></a>
      </div>
      <div class="col-md-4 col-sm-4 col-xs-4" style="margin-top: 10px;">
        <a onclick=""; return false; href=""><img src="<?php echo constant('URL')?>public/img/admin.png"  /></a>
      </div>
      <div class="col-md-4 col-sm-4 col-xs-4" style="margin-top: 10px;">
        <a onclick="" href=""><img src="<?php echo constant('URL')?>public/img/empire.png" /></a>
      </div>
    </div>
  </div>
